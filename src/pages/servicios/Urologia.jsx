...
export default function Urologia() {
  ...
  const mensajePredeterminado = encodeURIComponent("Hola, quisiera reservar una cita para Urología en Policlínico Chrisal-Lab.");
        ...
        <div style={styles.cardContainer}>
          ...
          <div style={styles.infoColumn}>
            ...
            <p style={styles.subtitle}>
              Atención especializada en la salud del sistema urinario y reproductor masculino
            </p>
            ...
            >
              ...
              Quiero reservar cita en Urología
            </a>
