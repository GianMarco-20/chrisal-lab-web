...
import doctorImg from '../../assets/obstetricia-doctor.jpg'; // Agrega la imagen en assets

export default function Obstetricia() {
  const numeroTelefono = "51978162605"; 
  const mensajePredeterminado = encodeURIComponent("Hola, quisiera reservar una cita para Obstetricia en Policlínico Chrisal-Lab.");
        ...
        <div style={styles.cardContainer}>
          ...
          <div style={styles.infoColumn}>
            ...
            <p style={styles.subtitle}>
              Cuidado y monitoreo integral de la mujer durante el embarazo, parto, posparto y control de la salud reproductiva.
            </p>
            ...
            >
              ...
              Quiero reservar cita en Obstetricia
            </a>
