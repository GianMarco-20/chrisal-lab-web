...
export default function Endocrinologia() {
  ...
  const mensajePredeterminado = encodeURIComponent("Hola, quisiera reservar una cita para Endocrinología en Policlínico Chrisal-Lab.");
      ...
      <div style={styles.contentWrapper}>
        ...
        <div style={styles.cardContainer}>
          <div style={styles.imageColumn}>
            <img 
              src={doctorImg} 
              alt="Endocrinología - Chrisal Lab" 
              style={styles.image}
            />
          </div>
          ...
          <div style={styles.infoColumn}>
            ...
            <p style={styles.subtitle}>
              Atención especializada en el sistema endocrino, metabolismo y equilibrio hormonal.
            </p>
            ...
            >
              ...
              Quiero reservar cita en Endocrinología
            </a>
          </div>
        </div>
      </div>
