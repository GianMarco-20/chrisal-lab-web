...
import doctorImg from '../../assets/podologia-doctor.jpg'; // Agrega la imagen en assets

export default function Podologia() {
  const numeroTelefono = "51978162605"; 
  const mensajePredeterminado = encodeURIComponent("Hola, quisiera reservar una cita para Podología en Policlínico Chrisal-Lab.");
        ...
        <div style={styles.cardContainer}>
          ...
          <div style={styles.infoColumn}>
            ...
            <p style={styles.subtitle}>
              Especialistas en salud podológica y cuidado de tus pies. ¡Salud y bienestar desde tus pies!
            </p>
            ...
            >
              ...
              Quiero reservar cita en Podología
            </a>
