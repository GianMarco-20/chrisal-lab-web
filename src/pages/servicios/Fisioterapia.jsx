...
import doctorImg from '../../assets/fisioterapia-doctor.jpg'; // Agrega la imagen en assets

export default function Fisioterapia() {
  const numeroTelefono = "51978162605"; 
  const mensajePredeterminado = encodeURIComponent("Hola, quisiera reservar una cita para Fisioterapia en Policlínico Chrisal-Lab.");
        ...
        <div style={styles.cardContainer}>
          ...
          <div style={styles.infoColumn}>
            ...
            <p style={styles.subtitle}>
              Tratamiento y rehabilitación física para la recuperación funcional, alivio del dolor y mejora de tu movilidad.
            </p>
            ...
            >
              ...
              Quiero reservar cita en Fisioterapia
            </a>
